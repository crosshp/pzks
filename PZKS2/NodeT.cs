...
namespace PZKS2
{
    public partial class NodeT : Control
    {
        public int number;
        public int mass;
        ...
        public NodeT(int number_in, int mass_in)
        {
            number = number_in;
            mass = mass_in;
        }
        ...
        protected override void OnPaint(PaintEventArgs e)
        {
            ...
            else g.DrawEllipse(new Pen(Color, 2), new Rectangle(1, 1, this.Width - 2, this.Height - 2));
